  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">教师工作考核绩效管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="教师邮箱" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshiyouxiang" autocomplete="off" placeholder="教师邮箱" type="text" />
																																																						...
																																																						<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">督导工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dudaogonghao" class="input" type="text" placeholder="督导工号">
			   </div>
			 </div> -->
			<el-form-item label="督导工号" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaogonghao" autocomplete="off" placeholder="督导工号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">督导姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.dudaoxingming" class="input" type="text" placeholder="督导姓名">
			   </div>
			 </div> -->
			<el-form-item label="督导姓名" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.dudaoxingming" autocomplete="off" placeholder="督导姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='dudao'" class="input-group">
			   <div class="label">联系电话</div>
			   <div class="input-container">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='dudao'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                        ...
                                                                                                                        if((!this.ruleForm.dudaogonghao) && `dudao` == this.tableName){
        this.$message.error(`督导工号不能为空`);
        return
      }
                                                            if((!this.ruleForm.mima) && `dudao` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                            if((!this.ruleForm.dudaoxingming) && `dudao` == this.tableName){
        this.$message.error(`督导姓名不能为空`);
        return
      }
                                                                                                                                                                                                                                                                              this.$http({
