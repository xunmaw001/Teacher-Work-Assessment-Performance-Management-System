  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="职称" prop="zhicheng">
              <el-input v-model="ruleForm.zhicheng" 
                placeholder="职称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="督导评分" prop="dudaopingfen">
          <el-select v-model="ruleForm.dudaopingfen" placeholder="请选择督导评分">
            <el-option
                v-for="(item,index) in dudaopingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="督导评分" prop="dudaopingfen">
	      <el-input v-model="ruleForm.dudaopingfen"
                placeholder="督导评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="督导工号" prop="dudaogonghao">
          <el-input v-model="ruleForm.dudaogonghao" 
              placeholder="督导工号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="督导工号" prop="dudaogonghao">
              <el-input v-model="ruleForm.dudaogonghao" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="督导姓名" prop="dudaoxingming">
          <el-input v-model="ruleForm.dudaoxingming" 
              placeholder="督导姓名" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="督导姓名" prop="dudaoxingming">
              <el-input v-model="ruleForm.dudaoxingming" 
                placeholder="督导姓名" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="督导评价" prop="dudaopingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="督导评价"
                  v-model="ruleForm.dudaopingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dudaopingjia" label="督导评价" prop="dudaopingjia">
                    <span>{{ruleForm.dudaopingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='dudaopingfen'){
            this.ruleForm.dudaopingfen = obj[o];
            continue;
          }
                    if(o=='dudaopingjia'){
            this.ruleForm.dudaopingjia = obj[o];
            continue;
          }
                    if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                                                        this.ruleForm.dudaogonghao = json.dudaogonghao
                                                this.ruleForm.dudaoxingming = json.dudaoxingming
                              } else {
          this.$message.error(data.msg);
        }
      });
                                                                                                this.dudaopingfenOptions = "1,2,3,4,5".split(',')
                                                                                                    },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
        url: `dudaopingjia/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dudaopingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dudaopingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
