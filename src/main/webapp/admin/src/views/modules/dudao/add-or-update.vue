...
export default {
            ...
            ruleForm: {
                	        dudaogonghao: '',
	                        	        ...
	                        	        lianxidianhua: '',
                                                ...
                                                rules: {
                  dudaogonghao: [
                            { required: true, message: '督导工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
                            { required: true, message: '密码不能为空', trigger: 'blur' },
                                    	                                                              ],
                  dudaoxingming: [
                            { required: true, message: '督导姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingbie: [
                                    	                                                              ],
                  touxiang: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dudao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dudaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
