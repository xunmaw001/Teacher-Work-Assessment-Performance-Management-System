<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="留言标题" prop="liuyanbiaoti">
          <el-input v-model="ruleForm.liuyanbiaoti" 
              placeholder="留言标题" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="留言标题" prop="liuyanbiaoti">
              <el-input v-model="ruleForm.liuyanbiaoti" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='liuyanbiaoti'){
            this.ruleForm.liuyanbiaoti = obj[o];
            continue;
          }
                    if(o=='liuyanriqi'){
