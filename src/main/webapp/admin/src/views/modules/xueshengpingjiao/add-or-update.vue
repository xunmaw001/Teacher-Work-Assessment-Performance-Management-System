      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="学年" prop="xuenian">
          <el-input v-model="ruleForm.xuenian" 
              placeholder="学年" clearable ></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="学期" prop="xueqi">
              <el-input v-model="ruleForm.xueqi" 
                placeholder="学期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学评分" prop="jiaoxuepingfen">
          <el-select v-model="ruleForm.jiaoxuepingfen" placeholder="请选择教学评分">
            <el-option
                v-for="(item,index) in jiaoxuepingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.jiaoxuepingfen"
                placeholder="教学评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学趣味" prop="jiaoxuequwei">
          <el-select v-model="ruleForm.jiaoxuequwei" placeholder="请选择教学趣味">
            <el-option
                v-for="(item,index) in jiaoxuequweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="教学趣味" prop="jiaoxuequwei">
	      <el-input v-model="ruleForm.jiaoxuequwei"
                placeholder="教学趣味" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="沟通表达" prop="goutongbiaoda">
          <el-select v-model="ruleForm.goutongbiaoda" placeholder="请选择沟通表达">
            <el-option
                v-for="(item,index) in goutongbiaodaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="沟通表达" prop="goutongbiaoda">
	      <el-input v-model="ruleForm.goutongbiaoda"
                placeholder="沟通表达" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人建议" prop="gerenjianyi">
          <el-input v-model="ruleForm.gerenjianyi" 
              placeholder="个人建议" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人建议" prop="gerenjianyi">
              <el-input v-model="ruleForm.gerenjianyi" 
                placeholder="个人建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
                	        ...
                	        jiaoshigonghao: '',
	                        	        ...
	                        	        banji: '',
	                        	                        	        shhf: '',
                                                                                                                          ...
                                                                                                                          jiaoxuepingfenOptions: [],
                                jiaoxuequweiOptions: [],
                                goutongbiaodaOptions: [],
                                                                                                        rules: {
                  jiaoshigonghao: [
                                    	                                                              ],
                  jiaoshixingming: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jiaoxuequwei'){
            this.ruleForm.jiaoxuequwei = obj[o];
            continue;
          }
                    if(o=='goutongbiaoda'){
            this.ruleForm.goutongbiaoda = obj[o];
            continue;
          }
                    if(o=='gerenjianyi'){
            this.ruleForm.gerenjianyi = obj[o];
            continue;
          }
                    if(o=='xuehao'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                        ...
                                                                                                                                                                        this.jiaoxuepingfenOptions = "1,2,3,4,5".split(',')
                                        this.jiaoxuequweiOptions = "1,2,3,4,5".split(',')
                                        this.goutongbiaodaOptions = "1,2,3,4,5".split(',')
                                                                                                                                        },
                                                                                                                                        // 多级联动参数
                                                                                                                                                                            info(id) {
      this.$http({
        url: `xueshengpingjiao/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueshengpingjiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshengpingjiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
