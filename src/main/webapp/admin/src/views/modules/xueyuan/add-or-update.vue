  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="学院" prop="xueyuan">
              <el-input v-model="ruleForm.xueyuan" 
                placeholder="学院" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="绩效考核" prop="jixiaokaohe">
          <el-select v-model="ruleForm.jixiaokaohe" placeholder="请选择绩效考核">
            <el-option
                v-for="(item,index) in jixiaokaoheOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="绩效考核" prop="jixiaokaohe">
	      <el-input v-model="ruleForm.jixiaokaohe"
                placeholder="绩效考核" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学院评分" prop="xueyuanpingfen">
          <el-select v-model="ruleForm.xueyuanpingfen" placeholder="请选择学院评分">
            <el-option
                v-for="(item,index) in xueyuanpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="学院评分" prop="xueyuanpingfen">
	      <el-input v-model="ruleForm.xueyuanpingfen"
                placeholder="学院评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="年度" prop="niandu">
          <el-input v-model="ruleForm.niandu" 
              placeholder="年度" clearable ></el-input>
        </el-form-item>
        <div v-else>
    ...
    return {
      ...
      type: '',
            ruleForm: {
                  ...
                  xueyuanpingfen: [
                            { required: true, message: '学院评分不能为空', trigger: 'blur' },
                                    	                                                              ],
                  niandu: [
                                    	                                                              ],
                  xueqi: [
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jixiaokaohe'){
            this.ruleForm.jixiaokaohe = obj[o];
            continue;
          }
                    if(o=='xueyuanpingfen'){
            this.ruleForm.xueyuanpingfen = obj[o];
            continue;
          }
                    if(o=='niandu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.jixiaokaoheOptions = "S,A,B,C".split(',')
                                        this.xueyuanpingfenOptions = "S,A,B,C".split(',')
                                                                },
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
