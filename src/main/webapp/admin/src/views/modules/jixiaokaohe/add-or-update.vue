      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="考核内容" prop="kaoheneirong">
          <el-input v-model="ruleForm.kaoheneirong" 
              placeholder="考核内容" clearable ></el-input>
        </el-form-item>
        <div v-else>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="考核评分" prop="kaohepingfen">
          <el-select v-model="ruleForm.kaohepingfen" placeholder="请选择考核评分">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.kaohepingfen"
                placeholder="考核评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考核情况" prop="kaoheqingkuang">
          <el-select v-model="ruleForm.kaoheqingkuang" placeholder="请选择考核情况">
            <el-option
                v-for="(item,index) in kaoheqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.kaoheqingkuang"
                placeholder="考核情况" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="奖惩情况" prop="jiangchengqingkuang">
          <el-select v-model="ruleForm.jiangchengqingkuang" placeholder="请选择奖惩情况">
            <el-option
                v-for="(item,index) in jiangchengqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="奖惩情况" prop="jiangchengqingkuang">
	      <el-input v-model="ruleForm.jiangchengqingkuang"
                placeholder="奖惩情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖惩内容" prop="jiangchengneirong">
          <el-input v-model="ruleForm.jiangchengneirong" 
              placeholder="奖惩内容" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖惩内容" prop="jiangchengneirong">
              <el-input v-model="ruleForm.jiangchengneirong" 
                placeholder="奖惩内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
            ...
            ruleForm: {
                	        jiaoshigonghao: '',
	                        	        ...
	                        	        beizhu: '',
                                                                                                            ...
                                                                                                            kaohepingfenOptions: [],
                                kaoheqingkuangOptions: [],
                                jiangchengqingkuangOptions: [],
                                                              rules: {
                  jiaoshigonghao: [
                                    	                                                              ],
                  jiaoshixingming: [
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jiangchengqingkuang'){
            this.ruleForm.jiangchengqingkuang = obj[o];
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                      ...
                                                                                                                                                      this.kaohepingfenOptions = "1,2,3,4,5".split(',')
                                        this.kaoheqingkuangOptions = "优秀,合格,较差".split(',')
                                        this.jiangchengqingkuangOptions = "奖励,罚处,无".split(',')
                                                                                  },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
